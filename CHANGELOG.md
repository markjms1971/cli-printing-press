...
## [4.32.0](https://github.com/markjms1971/cli-printing-press/compare/v4.31.3...v4.32.0) (2026-08-30)
...
* **catalog:** add Plane project-management catalog entry ([#2598](https://github.com/markjms1971/cli-printing-press/issues/2598)) ([91245f6](https://github.com/markjms1971/cli-printing-press/commit/91245f67e1cde1c0f319e8d552f4b2fc81524216))
* **catalog:** add shipping tracker blueprint ([#2649](https://github.com/markjms1971/cli-printing-press/issues/2649)) ([4bfd960](https://github.com/markjms1971/cli-printing-press/commit/4bfd960b73f96d0ec4c4935ab6059b0426427a47))
* **catalog:** add tidycal ([#2565](https://github.com/markjms1971/cli-printing-press/issues/2565)) ([683d849](https://github.com/markjms1971/cli-printing-press/commit/683d849c430ae25cd632873e33e88be1cf0a4738))
...
* **cli:** add BLE device-sniff and device-spec CLI generation ([#2601](https://github.com/markjms1971/cli-printing-press/issues/2601)) ([4e0e8f8](https://github.com/markjms1971/cli-printing-press/commit/4e0e8f845aaec9031cb3543aeec8190185d8aa96))
...
* **cli:** port self-teaching loop into generator templates ([#2440](https://github.com/markjms1971/cli-printing-press/issues/2440)) ([eb7ef10](https://github.com/markjms1971/cli-printing-press/commit/eb7ef10deee696b7a962873b7d2c93a5b8d6b67e))
...
* **skills:** add currency-version floor that hard-blocks generation on stale binaries ([#2567](https://github.com/markjms1971/cli-printing-press/issues/2567)) ([ef0ec66](https://github.com/markjms1971/cli-printing-press/commit/ef0ec661c1d01618d61c39de72c1c33eb5e56083))
...
* **ci:** bump Go to 1.26.4 to clear GO-2026-5037 / GO-2026-5039 stdlib advisories ([#2612](https://github.com/markjms1971/cli-printing-press/issues/2612)) ([a4fcff7](https://github.com/markjms1971/cli-printing-press/commit/a4fcff797bb914fea6e9fd3d8608f0bc661b28f5))
...
* **ci:** raise Mergify max_parallel_checks to 5 and exclude draft PRs ([#2663](https://github.com/markjms1971/cli-printing-press/issues/2663)) ([842f612](https://github.com/markjms1971/cli-printing-press/commit/842f6126adf2c07460a7e786a0ff834b19cfbb40))
...
* **cli:** always emit RequestBaseURL() so novel commands keep BasePath ([#2520](https://github.com/markjms1971/cli-printing-press/issues/2520)) ([6db6972](https://github.com/markjms1971/cli-printing-press/commit/6db6972089b35c24e7071c7c5ed7c640c4b528a7))
...
* **cli:** annotate read-only framework MCP commands ([#2700](https://github.com/markjms1971/cli-printing-press/issues/2700)) ([1b7129b](https://github.com/markjms1971/cli-printing-press/commit/1b7129b8b954d0d8e65a274e98833b58e4ab9393))
...
* **cli:** ASCII-fold in CamelIdentifier so non-ASCII names don't corrupt identifiers ([#2555](https://github.com/markjms1971/cli-printing-press/issues/2555)) ([0c18120](https://github.com/markjms1971/cli-printing-press/commit/0c1812055a5e674ffa495485f0b44eba502947ef))
...
* **cli:** bound remote spec fetch with a timeout and size cap ([#2558](https://github.com/markjms1971/cli-printing-press/issues/2558)) ([443d9ae](https://github.com/markjms1971/cli-printing-press/commit/443d9aed6d6b66a5ec0848fe9784b5337062c0ea))
...
* **cli:** bump emitted go directive to 1.26.4 ([#2627](https://github.com/markjms1971/cli-printing-press/issues/2627)) ([a21d796](https://github.com/markjms1971/cli-printing-press/commit/a21d7969f2decf0efe47cd54cd6099087fe3d56f))
...
* **cli:** dedup intentEndpoints map + 0600/0700 cache perms + cobratree shell-arg quoting ([#2697](https://github.com/markjms1971/cli-printing-press/issues/2697)) ([dede887](https://github.com/markjms1971/cli-printing-press/commit/dede887e828be33acbfa24364b12ad3bcaaf314a))
...
* **cli:** emit GraphQL-aware import for GraphQL specs, not REST POST ([#2618](https://github.com/markjms1971/cli-printing-press/issues/2618)) ([7ba6fb0](https://github.com/markjms1971/cli-printing-press/commit/7ba6fb0af5abd25f445c22b1da5f56476c3c029f))
...
* **cli:** emit valid JSON for sync_warning events ([#2643](https://github.com/markjms1971/cli-printing-press/issues/2643)) ([dec1fc9](https://github.com/markjms1971/cli-printing-press/commit/dec1fc9336b0b8112381bb1339fcc9f41c663836))
...
* **cli:** exclude scalar-array and sampler endpoints from sync selection ([#2549](https://github.com/markjms1971/cli-printing-press/issues/2549)) ([54ecd9e](https://github.com/markjms1971/cli-printing-press/commit/54ecd9e5205012991335fd6096e8f29d2803f465))
...
* **cli:** gate novel-feature Help guard on positional + non-placeholder parent Short ([#2694](https://github.com/markjms1971/cli-printing-press/issues/2694)) ([505998c](https://github.com/markjms1971/cli-printing-press/commit/505998c1f05535285ba740857727d8ea07ab2adc))
...
* **cli:** honor explicit has_more:false in sync page-int fallback + add metadata envelope key ([#2696](https://github.com/markjms1971/cli-printing-press/issues/2696)) ([b5f7fe3](https://github.com/markjms1971/cli-printing-press/commit/b5f7fe33afd468c4715b853353a48d737ed562f8))
...
* **cli:** keep defaulted high-frequency query params in global filter ([#2678](https://github.com/markjms1971/cli-printing-press/issues/2678)) ([a12e75c](https://github.com/markjms1971/cli-printing-press/commit/a12e75ca8f734ce2d81079e79ec7218633f32e0e))
...
* **cli:** live dogfood happy-path honors pp:happy-args ([#2642](https://github.com/markjms1971/cli-printing-press/issues/2642)) ([d2ca5a2](https://github.com/markjms1971/cli-printing-press/commit/d2ca5a2cb3f31423658314340149d0cb05f2c86a))
...
* **cli:** pass --db to data-pipeline sql probes and WARN-skip the sync gate for pure-API CLIs ([#2691](https://github.com/markjms1971/cli-printing-press/issues/2691)) ([a856a73](https://github.com/markjms1971/cli-printing-press/commit/a856a7384263eb5e963c62980a7eaf549ccb6051))
...
* **cli:** platform-conditional --help validation timeout + accurate pipeline.Init doc ([#2695](https://github.com/markjms1971/cli-printing-press/issues/2695)) ([3166d73](https://github.com/markjms1971/cli-printing-press/commit/3166d73fecd4092b0cfc4c88d7b1a70b9f1ce0ae))
* **cli:** prefer Chrome profiles with auth cookies ([#2681](https://github.com/markjms1971/cli-printing-press/issues/2681)) ([067e947](https://github.com/markjms1971/cli-printing-press/commit/067e9476b165083f681bc7f51bd3aa2dcb826ed1))
...
* **cli:** preserve creator attribution on reprint ([#2634](https://github.com/markjms1971/cli-printing-press/issues/2634)) ([4e261dc](https://github.com/markjms1971/cli-printing-press/commit/4e261dca6d6e40a447a0a1685de5bc817210676a))
...
* **cli:** preserve live dogfood refresh credentials ([#2638](https://github.com/markjms1971/cli-printing-press/issues/2638)) ([29aba15](https://github.com/markjms1971/cli-printing-press/commit/29aba15f6bc78f1a38b1a159f5b83fa7b34313d7))
...
* **cli:** preserve manifest spec name in transient mcp-sync dirs ([#2698](https://github.com/markjms1971/cli-printing-press/issues/2698)) ([c36f8b4](https://github.com/markjms1971/cli-printing-press/commit/c36f8b46eb2b78039d77b90751aa73057054c6eb))
...
* **cli:** preserve sync cursor on max-pages cap ([#2543](https://github.com/markjms1971/cli-printing-press/issues/2543)) ([f7037d8](https://github.com/markjms1971/cli-printing-press/commit/f7037d8a4bef4117b72e29f07d1f4624978f58de))
...
* **cli:** re-inject lost registrations into their source function ([#2559](https://github.com/markjms1971/cli-printing-press/issues/2559)) ([288b4a5](https://github.com/markjms1971/cli-printing-press/commit/288b4a5d584ef93fcb35e3e19adf5590486c68be))
...
* **cli:** rebuild FTS after rowid migration ([#2542](https://github.com/markjms1971/cli-printing-press/issues/2542)) ([79c8acf](https://github.com/markjms1971/cli-printing-press/commit/79c8acf3661a9bee030adfa46fe10c5e27812e52))
...
* **cli:** recognize Google "Login Required" 401 envelope and rebuild staged binary in dogfood --live ([#2690](https://github.com/markjms1971/cli-printing-press/issues/2690)) ([991c35d](https://github.com/markjms1971/cli-printing-press/commit/991c35d6136b35708a375a97a7e98a24677dfae8))
...
* **cli:** redact token= credentials + accurate SQL tool schema description ([#2701](https://github.com/markjms1971/cli-printing-press/issues/2701)) ([aee10fa](https://github.com/markjms1971/cli-printing-press/commit/aee10fac925535243a4ecd8af2ac67cf5d8c2f5d))
...
* **cli:** resolve GraphQL custom root operation types ([#2556](https://github.com/markjms1971/cli-printing-press/issues/2556)) ([b0b4147](https://github.com/markjms1971/cli-printing-press/commit/b0b41473ed9c4b27a61ee550d4e04ee6cf653d3f))
...
* **cli:** scorer multi-spec path_validity + docsync novel-feature Go-surface resync and drop-warning ([#2693](https://github.com/markjms1971/cli-printing-press/issues/2693)) ([298c46f](https://github.com/markjms1971/cli-printing-press/commit/298c46fdba1b5b24d68041074638da8c4aa58894))
...
* **cli:** support standalone pycookiecheat ([#2725](https://github.com/markjms1971/cli-printing-press/issues/2725)) ([3d70c16](https://github.com/markjms1971/cli-printing-press/commit/3d70c169ef8c240257ca1f925489d4e86e05769e))
...
* **cli:** surface row errors in generated MCP sql tool ([#2650](https://github.com/markjms1971/cli-printing-press/issues/2650)) ([2af370c](https://github.com/markjms1971/cli-printing-press/commit/2af370c7525c45be9bff818dc018988a387b9b8b))
...
* **generator:** rely on installer default bin directory ([#2654](https://github.com/markjms1971/cli-printing-press/issues/2654)) ([0a9969c](https://github.com/markjms1971/cli-printing-press/commit/0a9969cc3c32313a04c6c27cebb36b79b8a0b42a))
...
* **patches:** emit per-patch directory layout (generator + skills) ([#2581](https://github.com/markjms1971/cli-printing-press/issues/2581)) ([a826d31](https://github.com/markjms1971/cli-printing-press/commit/a826d31617d635c8fd7717e9edf0ebf213797af0))
